...
if (!empty($_GET['card'])) {
    $card = '<img src="icon/check.gif" width="15" height="15">';
    $comm = 'บริษัท เพาเวอร์ โซลูชั่น เทคโนโลยี จำกัด (มหาชน)';
    $nt = $nameth;
    $lt = $lastnameth;
    $ne = $nameen;
    $le = $lastnameen;
    ...
    $card = '<img src="icon/uncheck.gif" width="15" height="15">';
    $descard = "";
    $comm = '';
    $nt = '';
    $lt = '';
...
<body>
    ...
    $body = "<table style='width: 100%;border-collapse: collapse;border: 1px solid black;text-align: center;'>
                ...
                <tr>
                    ...
                    <td style='border: 1px solid black;'>ฟหกด</td>
                    <td style='border: 1px solid black;'>asd</td>
                    <td style='border: 1px solid black;'>1234</td>
                    <td style='border: 1px solid black;'>asd@asd</td>
                    <td style='border: 1px solid black;'>asd</td>
                    <td style='border: 1px solid black;'>asd</td>
    ...
    try {
        ...
        $mail->addAddress('pakkawat.p@pst.co.th');
